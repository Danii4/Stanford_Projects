...
public class ImageShop extends GraphicsProgram {
	...
	private void addButtons() {
		...
		add(new JButton("Color Swap"), WEST); //new button

		infoLabel = new JLabel("Welcome to ImageShop!");
		add(infoLabel, NORTH);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals("Load Image")) { 
			loadImage();
		} else if(command.equals("Color Swap")) { //new command
			GImage newImage = algorithms.colorSwap(currentImage);
			setImage(newImage);
